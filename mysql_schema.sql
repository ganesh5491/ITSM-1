...
('admin', '$2b$10$af0vnH5V.fzyiq1sF1FFe.Z.yrJGT3MxTnR5U1fih7yc9LbZNb0.S', 'Admin User', 'admin@company.com', 'admin', 'Tech Corp', 'IT', '+1-555-0001', 'System Administrator'),
('agent', '$2b$10$1OtfRyQzC2mKVM1OFSN3M.LapbKF/mBXDOs9BiYKYMLq2qfh7c/Re', 'Agent User', 'agent@company.com', 'agent', 'Tech Corp', 'IT Support', '+1-555-0002', 'Support Specialist'),
('user', '$2b$10$39XQvg6mMgn/PyiHmJrMg.9uAtmbQ1kZPoo0aqBO3sjLvTyRc6Qta', 'Regular User', 'user@company.com', 'user', 'Tech Corp', 'Marketing', '+1-555-0003', 'Marketing Manager'),
('john.doe', '$2b$10$6Xq3h8c2Z1.T7Q9w3V5h1OjY4S8N6Z2K1L3M4B5.C6D7E8F9G0H1I2J3', 'John Doe', 'john.doe@company.com', 'user', 'Tech Corp', 'Sales', '+1-555-0004', 'Sales Representative'),
('jane.smith', '$2b$10$6Xq3h8c2Z1.T7Q9w3V5h1OjY4S8N6Z2K1L3M4B5.C6D7E8F9G0H1I2J3', 'Jane Smith', 'jane.smith@company.com', 'agent', 'Tech Corp', 'IT Support', '+1-555-0005', 'Senior Support Analyst');
